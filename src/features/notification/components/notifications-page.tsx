...
export default function NotificationsPage() {
 ...
 <Button
 variant="outline"
 className="h-9 px-4 rounded-xl border-border/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] hover:bg-card border-border bg-card dark:hover:bg-card"
 >
 ...
 <div className="flex flex-col rounded-xl border border-border/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card overflow-hidden">
 ...
 <div
 key={i}
 className={`flex items-start gap-4 p-5 sm:p-6 transition-colors hover:bg-card/80 dark:hover:bg-card/30 ${i !== alerts.length - 1 ? "border-b border-border" : ""}`}
 >
 <div
