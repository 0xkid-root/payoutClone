...
export function VanTable({ onViewDetails }: VanTableProps) {
 ...
 return (
 <div className="flex flex-col gap-4 bg-card rounded-xl border border-border/60 border-border shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] p-6 h-full">
 <div className="flex flex-col sm:flex-row items-center gap-4 justify-between">
 <div className="relative w-full sm:w-96">
 <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
 <Input 
 placeholder="Search VAN, merchant, merchant ID..." 
 className="pl-9 bg-card bg-card/50"
 value={globalFilter}
 ...
 <SelectTrigger className="w-[140px] bg-card bg-card/50">
 ...
 <SelectTrigger className="w-[160px] bg-card bg-card/50">
