...
export function WalletDetailsPage({ walletId }: { walletId: string }) {
 ...
 {/* Wallet Overview */}
 <div className="rounded-[14px] border border-border/60 shadow-sm border-border bg-card overflow-hidden">
 ...
 <TableRow key={tx.id} className="h-14 border-b border-border/60 hover:bg-card dark:hover:bg-card/30 transition-colors">
