        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-xl border border-border/60 bg-white shadow-sm border-border bg-background overflow-hidden flex-1">
            ...
            <div className="p-2 space-y-1">
              <Link href="/wallet/fund-requests" className="flex items-center justify-between p-3 rounded-lg hover:bg-background dark:hover:bg-card/50 transition-colors group">
                <div className="flex items-center gap-3">
              ...
              <Link href="/wallet/withdrawals" className="flex items-center justify-between p-3 rounded-lg hover:bg-background dark:hover:bg-card/50 transition-colors group">
                <div className="flex items-center gap-3">
              ...
              <Link href="/wallet/adjustments" className="flex items-center justify-between p-3 rounded-lg hover:bg-background dark:hover:bg-card/50 transition-colors group">
                <div className="flex items-center gap-3">
