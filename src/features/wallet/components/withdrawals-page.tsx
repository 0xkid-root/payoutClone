...
export function WithdrawalsPage() {
 ...
 <TableHead className="h-11 px-5 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Bank Account</TableHead>
 ...
 <span className="font-mono text-foreground dark:text-white">{selectedRequest.accountNumber}</span>
 </div>
 <div className="flex justify-between items-center text-sm">
 <span className="text-muted-foreground">IFSC</span>
 <span className="font-mono text-foreground dark:text-white">{selectedRequest.ifsc}</span>
 </div>
 </div>
 )}
