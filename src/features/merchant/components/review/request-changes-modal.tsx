...
export function RequestChangesModal({ isOpen, onClose, merchant }: RequestChangesModalProps) {
 ...
 <DialogContent className="sm:max-w-[500px] border-border/60 border-border shadow-xl bg-card">
 <DialogHeader>
 ...
 className="w-full rounded-md border p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none h-24 bg-card/50 border-border"
 value={reason}
