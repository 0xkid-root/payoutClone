        ...
        <div className="grid grid-cols-1 divide-y divide-slate-100 dark:divide-slate-800">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex justify-between py-2.5 px-4">
                <span className="text-[13px] text-muted-foreground">Website</span>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex justify-between py-2.5 px-4">
                <span className="text-[13px] text-muted-foreground">Incorporation Date</span>
                <span className="text-[13px] font-medium text-foreground dark:text-white">12 Jan 2021</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex justify-between py-2.5 px-4">
                ...
                <span className="text-[13px] font-medium text-foreground dark:text-white">{merchant.ifscCode || "N/A"}</span>
              </div>
            </div>
          </div>
        </div>
