...
export function ReviewApprovalDialog({ isOpen, type, merchant, onClose }: ReviewApprovalDialogProps) {
 ...
 <select 
 className="flex h-10 w-full items-center justify-between rounded-md border border-border px-3 py-2 text-sm ring-offset-white placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus-visible:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 border-border bg-card ring-offset-background dark:placeholder:text-muted-foreground focus-visible:ring-ring"
 value={reason}
 ...
 <textarea 
 className="flex min-h-[80px] w-full rounded-md border border-border px-3 py-2 text-sm ring-offset-white placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 border-border bg-card ring-offset-background dark:placeholder:text-muted-foreground focus-visible:ring-ring"
 ...
 <div className="rounded-lg bg-card p-4 bg-card/50 my-4">
