  ...
  return (
    <div className="grid grid-cols-1 divide-y divide-slate-100 dark:divide-slate-800 border-t border-slate-100 border-border">
      ...
      <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100 dark:divide-slate-800">
        <div className="p-6 bg-slate-50/10 bg-background/10">
      ...
      <div>
        <div className="px-5 py-4 bg-slate-50/50 bg-background/20 border-b border-slate-100 border-border flex flex-row items-center justify-between">
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center justify-between py-4 px-5">
                ...
                <div className="flex flex-col items-end">
                  <span className={`text-[13px] font-semibold tabular-nums ${i % 2 === 0 ? "text-foreground dark:text-white" : "text-emerald-600"}`}>
