...
export function MerchantDetailsPage({ merchantId }: { merchantId: string }) {
 ...
 <div className="rounded-xl border border-border/60 shadow-sm border-border bg-card overflow-hidden flex flex-col mt-4">
 {/* Tabs Navigation */}
 <div className="border-b border-border/60 border-border bg-card/50 p-2 flex overflow-x-auto scrollbar-hide">
 {tabs.map((tab) => {
 ...
 {/* Tab Content */}
 <div className=" bg-card p-0 pb-2 [&>div]:border-0 [&>div]:rounded-none [&>div]:shadow-none">
