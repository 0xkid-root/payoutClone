...
export function VerifyOtpForm() {
 ...
 type="text" 
 maxLength={1}
 className="w-11 h-11 sm:w-12 sm:h-12 rounded-lg text-center text-[18px] font-bold bg-card border border-border transition-all focus-visible: focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary shadow-sm"
 />
 ))}
 </div>
