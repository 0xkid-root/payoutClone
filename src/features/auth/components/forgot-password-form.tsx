...
export function ForgotPasswordForm() {
 ...
 className="h-11 rounded-lg border border-border bg-card pl-10 text-[14px] font-medium transition-all placeholder:text-muted-foreground hover:bg-muted focus-visible: focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary shadow-sm"
 />
 </div>
 </div>
 ...
 "flex h-11 w-full justify-center rounded-lg border-border text-[14px] font-semibold text-foreground shadow-sm transition-all hover:bg-card hover:text-foreground"
 )}
 >
 Back to Login
 </Link>
