...
export function RecentAlerts() {
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-border/60 bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-background">
      <div className="flex items-center justify-between border-b border-slate-100/50 p-6 border-border/50">
      ...
      <div className="flex flex-1 flex-col divide-y divide-slate-100 dark:divide-slate-800/50">
        {alerts.map((alert, i) => {
          ...
          return (
            <div key={i} className="flex items-start gap-3.5 p-5 hover:bg-slate-50/50 dark:hover:bg-card/20 transition-colors">
