...
export function RecentAlerts() {
 ...
 return (
 <div className="flex h-full flex-col rounded-xl border border-border/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
 ...
 return (
 <div key={i} className="flex items-start gap-3.5 p-5 hover:bg-card dark:hover:bg-card/20 transition-colors">
