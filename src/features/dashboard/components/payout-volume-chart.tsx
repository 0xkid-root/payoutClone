...
export function PayoutVolumeChart() {
 ...
 <div className="flex items-center gap-2">
 <button className="flex items-center gap-1 rounded-md border border-border px-3 py-1.5 text-[13px] font-medium text-muted-foreground shadow-sm border-border bg-card text-foreground">
 Amount (₹)
 <ChevronDown className="h-3 w-3" />
 </button>
 <div className="flex items-center rounded-md border border-border p-0.5 border-border bg-card">
 ...
 />
 <Tooltip 
 contentStyle={{ backgroundColor: 'var(--card)', color: 'var(--foreground)', borderRadius: "8px", 
