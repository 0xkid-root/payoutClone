...
const StatusBadge = ({ status }: { status: DashboardMerchant["status"] }) => {
 ...
 BLOCKED: "bg-card text-muted-foreground border-border/50",
 };
...
export function MerchantOverviewTable() {
 ...
 return (
 <div className="flex h-full flex-col rounded-xl border border-border/60 p-6 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
