...
export function RejectedTab() {
 ...
 <TableHead className="h-11 px-5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">Rejected On</TableHead>
 <TableHead className="h-11 px-5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground max-w-[200px]">Reason</TableHead>
 ...
 <TableRow key={req.id} className="border-border/60 hover:bg-card dark:hover:bg-card/30 transition-colors">
 ...
 <TableCell className="p-4 px-5">
 <div className="flex flex-col">
 <span className="font-medium text-foreground dark:text-white text-[13px]">{req.bankName}</span>
 ...
 <p className="text-[13px] text-muted-foreground truncate" title={req.rejectionReason}>
 {req.rejectionReason || "-"}
 </p>
 </TableCell>
 <TableCell className="p-4 px-5">
 <span className="inline-flex items-center rounded-full border border-danger/30 bg-danger/10 px-2.5 py-0.5 text-[11px] font-semibold text-danger dark:bg-danger/100/10">
 Rejected
 </span>
 </TableCell>
