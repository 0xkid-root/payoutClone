...
export default function VanManagementPage() {
 ...
 <Input placeholder="Search VANs..." className="h-10 w-full rounded-xl pl-9 bg-card border-border bg-card/50 border-border" />
 </div>
 ...
 <span className="font-medium text-foreground dark:text-white">{item.bank}</span>
 <span className="text-xs text-muted-foreground font-mono">{item.ifsc}</span>
 </div>
 </TableCell>
