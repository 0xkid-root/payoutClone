...
export function SettlementDetailsPage({ id = 'STL-000123' }: { id?: string }) {
 ...
 <div className="bg-card/50 rounded-lg p-6 space-y-4 font-mono text-sm">
 ...
 <div className="flex w-full flex-col rounded-xl border border-border/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card lg:col-span-2">
