...
export function ReconciliationDashboardPage() {
 ...
 <div className="lg:col-span-2 flex h-full min-h-[350px] w-full flex-col rounded-xl border border-border/60 p-6 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
 ...
 <div className="flex w-full flex-col rounded-xl border border-border/60 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
