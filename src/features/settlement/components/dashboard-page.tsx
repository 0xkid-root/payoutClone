...
export function SettlementDashboardPage() {
 ...
 {/* Hero Graph */}
 <div className="md:col-span-2 flex h-full min-h-[350px] w-full flex-col rounded-xl border border-border/60 p-6 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
 ...
 <div className="flex items-center gap-2 rounded-md border border-border p-0.5 border-border bg-card">
 {['7D', '30D', '90D'].map(t => (
 <button 
 key={t}
 ...
 {/* Donut Chart */}
 <div className="flex h-full min-h-[350px] w-full flex-col rounded-xl border border-border/60 p-6 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
 <div className="mb-2">
 ...
 {/* Settlement Health */}
 <div className="flex w-full flex-col rounded-xl border border-border/60 p-6 shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] border-border bg-card">
