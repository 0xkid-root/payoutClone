...
export function Sidebar({
 ...
 <div
 className={cn(
 "relative z-20 flex h-full flex-col border-r border-sidebar-border transition-all duration-300 ease-in-out border-sidebar-border bg-card",
