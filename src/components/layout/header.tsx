...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="flex h-[72px] items-center justify-between border-b border-border bg-white px-4 md:px-6 xl:px-8 border-border dark:bg-slate-950">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative hidden w-64 md:block lg:w-80 xl:w-96 group">
          ...
          <input
            ...
            className="h-10 w-full rounded-lg border border-border bg-slate-50/80 pl-10 pr-14 text-[14px] font-medium text-foreground transition-all placeholder:text-muted-foreground hover:bg-muted focus:bg-white focus:outline-none focus:ring-[3px] focus:ring-primary/10 focus:border-primary shadow-sm border-border bg-background/50 dark:text-white dark:hover:bg-card dark:focus:bg-background dark:focus:ring-primary/20"
          />
        ...
        <div className="flex items-center gap-2 ml-2">
          <Button variant="outline" size="icon" className="relative h-10 w-10 rounded-lg border border-border bg-white shadow-sm text-muted-foreground hover:text-foreground hover:bg-slate-50 border-border bg-background text-muted-foreground dark:hover:text-white transition-colors">
