...
export function AdminLayout({ children }: { children: React.ReactNode }) {
 ...
 return (
 <div className="flex h-screen w-full bg-card overflow-hidden relative">
 {/* Desktop Sidebar */}
 <div
 className={cn(
 ...
 />
 {/* Sidebar */}
 <div className="fixed inset-y-0 left-0 z-50 w-[248px] shadow-2xl animate-in slide-in-from-left duration-300">
